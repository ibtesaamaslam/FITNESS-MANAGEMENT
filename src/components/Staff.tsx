...
const TimePickerInput: React.FC<{
  ...
  return (
    <div className="w-full bg-secondary border border-gray-700 focus-within:border-[#10b981] rounded-lg px-2 h-[38px] flex items-center justify-start gap-1.5 sm:gap-2 text-white font-mono text-xs select-none min-w-0 overflow-hidden">
...
export const Staff: React.FC<StaffProps> = ({
  ...
  const handleDeleteClick = (s: StaffMember, e?: React.MouseEvent) => {
    if (e) e.stopPropagation();
    if (role === 'Manager') {
      onNotify?.('Super Admin authority required to delete staff personnel.', 'error');
      return;
    }
    setStaffToDelete(s);
    ...
    <div className="p-4 md:p-8 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-800 pb-5">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="bg-secondary hover:bg-gray-700 text-text-primary border border-gray-700 font-semibold px-4 py-2 rounded-lg flex items-center gap-2 transition-all text-sm cursor-pointer shadow"
          >
          ...
          <button
            ...
            className="bg-primary hover:bg-primary-hover text-white font-semibold px-4 py-2 rounded-lg flex items-center gap-2 transition-all text-sm cursor-pointer shadow-lg"
          >
      ...
      <div className="flex items-center gap-8 border-b border-gray-800 text-sm">
        ...
        >
          ...
          {role === 'Manager' && (
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-gray-800 text-gray-400 border border-gray-700 font-normal">
              Admin Only
            </span>
          )}
        </button>
      ...
      {activeTab === 'directory' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            {/* Search & Filter Bar */}
            <div className="flex flex-col sm:flex-row gap-3 items-center justify-between bg-surface p-3.5 rounded-2xl border border-gray-800 shadow-lg">
              <div className="relative flex-1 w-full sm:max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-secondary text-white placeholder-gray-400 rounded-xl border border-gray-700/80 text-sm focus:outline-none focus:border-primary transition-all shadow-inner"
                />
              </div>
                  ...
                  <button
                    ...
                    className={`px-3.5 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all cursor-pointer whitespace-nowrap ${
                      selectedCategory === cat
                        ...
                        : 'bg-secondary text-gray-400 hover:text-white border border-transparent'
                    }`}
                  >
                    {cat}
                  </button>
              ...
              {filteredStaff.map((s) => {
                ...
                return (
                  <div
                    ...
                    className={`bg-surface rounded-xl p-5 border transition-all cursor-pointer relative flex flex-col justify-between shadow-md ${
                      isSelected 
                        ...
                        <div className="flex items-center gap-3 text-gray-400">
                          ...
                          {role === 'Admin' ? (
                            <button
                              ...
                              title="Delete Staff (Admin Only)"
                            >
                              <TrashIcon className="h-4 w-4" />
                            </button>
                          ) : (
                            <span className="text-[10px] px-1.5 py-0.5 rounded bg-gray-800/80 text-gray-500 border border-gray-700/40" title="Admin only delete">
                              Admin Only
                            </span>
                          )}
                        </div>
                      ...
                      <div>
                        ...
                        {role === 'Admin' ? (
                          ...
                          <div className="text-xs font-semibold text-gray-500 mt-0.5 flex items-center gap-1">
                            <LockIcon className="h-3 w-3 inline text-gray-500" />
          ...
          <div className="bg-surface rounded-xl border border-gray-800/80 p-6 shadow-lg flex flex-col justify-between min-h-[420px]">
            {!selectedStaff ? (
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start justify-between border-b border-gray-800 pb-4">
                  <div>
                    <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase bg-primary/20 text-primary border border-[#10b981]/30">
                      {selectedStaff.role}
                    </span>
                ...
                {/* Payroll & Shift Info */}
                <div className="space-y-3 bg-secondary/60 p-4 rounded-xl border border-gray-800">
                    ...
                    <div>
                      ...
                      {role === 'Admin' ? (
                        ...
                        <span className="text-xs font-semibold text-gray-500 flex items-center gap-1 mt-0.5">
                          <LockIcon className="h-3 w-3 inline text-gray-500" /> Admin Only
                        </span>
                      )}
                    </div>
                    <div>
                  ...
                  <div className="space-y-3 bg-secondary/60 p-4 rounded-xl border border-gray-800">
                    ...
                    <div className="flex items-center gap-2">
                      <select
                        ...
                        className="flex-1 bg-surface text-xs text-white p-2 rounded-lg border border-gray-700 focus:outline-none focus:border-primary"
                      >
                      ...
                      <button
                        ...
                        className="bg-primary hover:bg-[#0d9488] disabled:opacity-50 text-black font-bold text-xs px-3 py-2 rounded-lg cursor-pointer"
                      >
                        Assign
                      </button>
                    </div>
              ...
              return (
                <div key={col.short} className="flex flex-col space-y-4">
                  ...
                  <div className="space-y-4 flex-1">
                    {dayShifts.length > 0 ? (
                      dayShifts.map((s, idx) => (
                        <div key={idx} className="space-y-1 bg-secondary/60/50 p-2 rounded-lg border border-gray-800">
                          <div className="font-bold text-xs text-white">{s.name}</div>
                          <div className="flex flex-col gap-0.5 text-[11px]">
                            <span className="text-primary font-medium">{s.role}</span>
      ...
      {activeTab === 'attendance' && (
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-surface p-4 rounded-2xl border border-gray-800 shadow-lg">
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex items-center gap-2 bg-secondary px-3 py-1.5 rounded-xl border border-gray-700">
              ...
              <div className="flex items-center gap-1 bg-secondary p-1 rounded-xl border border-gray-700 overflow-x-auto">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-emerald-500/20 hover:bg-emerald-500/30 text-primary font-bold rounded-xl border border-emerald-500/30 text-xs flex items-center gap-2 cursor-pointer transition-all shadow"
              >
            ...
            <div className="relative w-full md:w-80">
              <SearchIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-gray-400 pointer-events-none" />
              <input
                type="text"
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
            <div className="bg-surface p-3.5 rounded-2xl border border-gray-800 space-y-1">
            ...
            <div className="bg-surface p-3.5 rounded-2xl border border-emerald-900/40 bg-gradient-to-b from-emerald-950/10 to-transparent space-y-1">
            ...
            <div className="bg-surface p-3.5 rounded-2xl border border-amber-900/40 bg-gradient-to-b from-amber-950/10 to-transparent space-y-1">
            ...
            <div className="bg-surface p-3.5 rounded-2xl border border-blue-900/40 bg-gradient-to-b from-blue-950/10 to-transparent space-y-1">
            ...
            <div className="bg-surface p-3.5 rounded-2xl border border-red-900/40 bg-gradient-to-b from-red-950/10 to-transparent space-y-1">
          ...
          <div className="bg-surface border border-gray-800 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs text-gray-300">
                <thead className="bg-secondary/60/80 text-gray-400 text-[11px] uppercase tracking-wider font-semibold border-b border-gray-800">
                  <tr>
                ...
                <tbody className="divide-y divide-gray-800/80">
                  {filteredAttendanceStaff.length > 0 ? (
                    filteredAttendanceStaff.map((s) => {
                      ...
                      return (
                        <tr key={s.id} className="hover:bg-secondary/60/40 transition-colors">
      ...
      {activeTab === 'payroll' && (
        role === 'Manager' ? (
          <div className="bg-surface border border-gray-800 rounded-2xl p-12 text-center max-w-xl mx-auto my-12 shadow-2xl space-y-4 animate-fade-in">
            ...
            <h3 className="text-xl font-bold text-white">Staff Payroll & Salaries Are Restricted</h3>
            <p className="text-sm text-gray-400 leading-relaxed max-w-md mx-auto">
              As Operations Manager, your access covers staff shift rosters and daily attendance logging. Staff compensation rates, bonus disbursements, and payroll slips require Super Admin authority.
            </p>
            <div className="pt-2">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-surface p-4 rounded-2xl border border-gray-800 shadow-lg">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-1 bg-secondary p-1 rounded-xl border border-gray-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-surface p-4 rounded-2xl border border-gray-800 space-y-2">
            ...
            {/* Stat 2: Total Paid */}
            <div className="bg-surface p-4 rounded-2xl border border-emerald-900/40 bg-gradient-to-b from-emerald-950/10 to-transparent space-y-2">
            ...
            <div className="bg-surface p-4 rounded-2xl border border-red-900/40 bg-gradient-to-b from-red-950/10 to-transparent space-y-2">
          ...
          <div className="bg-surface border border-gray-800 rounded-2xl overflow-hidden shadow-xl">
            <div className="p-4 border-b border-gray-800 flex items-center justify-between">
              <h3 className="text-sm font-bold text-white flex items-center gap-2">
                <FeesIcon className="h-4 w-4 text-primary" />
      ...
      {isAddEditModalOpen && (
        <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-surface border border-gray-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-5 my-8 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveStaff} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-secondary border border-gray-700 rounded-lg p-2.5 text-white focus:outline-none focus:border-primary"
                  />
              ...
              {role === 'Admin' ? (
                ...
                <div className="p-3 bg-gray-800/50 border border-gray-700/60 rounded-lg flex items-center justify-between text-xs">
                  <span className="text-gray-400">Compensation & Base Salary:</span>
                  <span className="text-gray-400 font-semibold flex items-center gap-1">
                    <LockIcon className="h-3 w-3 inline text-gray-500" /> Protected (Super Admin Only)
                  </span>
                </div>
              )}
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="bg-secondary/60 p-3.5 rounded-xl border border-gray-800 space-y-3">
                  <div className="flex flex-col sm:flex-row gap-2.5 items-end">
                    <div className="w-full sm:w-28 shrink-0">
                      ...
                      <select
                        ...
                        className="w-full bg-secondary border border-gray-700 rounded-lg p-2 text-white text-xs focus:outline-none focus:border-primary"
                      >
                  ...
                  <button
                    ...
                    className="w-full bg-primary/20 hover:bg-primary/30 text-primary font-bold py-2 px-4 rounded-lg border border-[#10b981]/50 text-xs cursor-pointer flex items-center justify-center gap-2 transition-all active:scale-[0.99]"
                  >
                    + Add Shift Schedule
                  </button>
                </div>
                ...
                <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
                  {formShifts.map((s, idx) => (
                    <div
                      key={idx}
                      className="bg-surface border border-gray-700/80 rounded-lg px-4 py-2.5 flex items-center justify-between text-xs"
                    >
              ...
              <div className="flex items-center justify-end gap-3 border-t border-gray-800 pt-4">
                <button
                  type="button"
                  onClick={() => setIsAddEditModalOpen(false)}
                  className="px-5 py-2.5 bg-secondary hover:bg-gray-700 text-gray-300 font-bold rounded-lg border border-gray-700 cursor-pointer text-xs transition-colors"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-primary hover:bg-primary-hover text-white font-bold rounded-lg cursor-pointer text-xs shadow-md transition-colors"
                >
                  Save Team Member
                </button>
              </div>
      ...
      {shiftToDeleteIndex !== null && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
          <div className="bg-surface border border-gray-800 rounded-2xl max-w-sm w-full p-6 shadow-2xl space-y-4">
      ...
      {isDeleteModalOpen && staffToDelete && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-surface border border-gray-800 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4">
      ...
      {isPayrollModalOpen && selectedStaffForPayroll && activePayrollAudit && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-surface border border-gray-800 rounded-2xl max-w-xl w-full p-6 shadow-2xl space-y-4 my-8 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-gray-800 pb-3">
              <div>
                <h3 className="text-base font-bold text-white">Record Salary Payout & Attendance Audit</h3>
                <p className="text-xs text-primary font-medium mt-0.5">{selectedStaffForPayroll.name} ({selectedStaffForPayroll.role})</p>
              </div>
            ...
            <div className="bg-secondary/60 border border-gray-700/80 rounded-xl p-3.5 space-y-2.5">
              <div className="flex items-center justify-between">
              ...
              <div className="bg-surface p-2.5 rounded-lg border border-gray-800 space-y-1.5 max-h-32 overflow-y-auto text-[11px]">
              ...
              <form onSubmit={handleSavePayroll} className="space-y-3 text-xs">
                <div>
                  ...
                  <input
                    ...
                    value={payrollMonth}
                    onChange={(e) => setPayrollMonth(e.target.value)}
                    className="w-full bg-secondary border border-gray-700 rounded-lg p-2 text-white font-mono"
                    required
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <div className="w-full bg-secondary/60 border border-gray-800 rounded-lg p-2 text-primary font-mono font-bold text-sm">
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-secondary border border-gray-700 rounded-lg p-2 text-white"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-secondary border border-gray-700 rounded-lg p-2 text-white font-mono font-bold"
                    required
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-gray-800">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-primary hover:bg-primary-hover text-white font-bold rounded-lg cursor-pointer shadow"
                >
                  Save Salary Payout
                </button>
              </div>
      ...
      {payslipModalRecord && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-surface border border-gray-800 rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-4 my-8">
            <div className="flex items-center justify-between border-b border-gray-800 pb-3">
              <div>
            ...
            {/* Slip Paper View */}
            <div className="bg-secondary p-5 rounded-xl border border-gray-700 space-y-4 text-xs">
              <div className="flex items-center justify-between border-b border-gray-700 pb-3">
                <div>
                  <p className="font-bold text-primary text-sm">GYM MANAGEMENT SYSTEM</p>
              ...
              <div className="border-t border-b border-gray-700 py-3 space-y-2">
                ...
                <div className="flex justify-between text-sm font-bold border-t border-gray-700 pt-2 text-primary">
      ...
      {isAttendanceModalOpen && selectedStaffForAttendance && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-surface border border-gray-800 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 my-8">
            <div className="flex items-center justify-between border-b border-gray-800 pb-3">
              <div>
                    ...
                    <button
                      ...
                      className={`p-2 rounded-lg font-bold border text-center cursor-pointer transition-all ${
                        attendanceForm.status === st
                          ...
                          : 'bg-secondary text-gray-400 border-gray-700 hover:text-white'
                      }`}
                    >
                      {st}
                    </button>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <button
                    ...
                    className="mt-1 text-[10px] text-primary hover:underline block cursor-pointer font-semibold"
                  >
                    Set to current time
                  </button>
                </div>
      ...
      {isFullMonthReportOpen && (
        <div className="fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-surface border border-gray-800 rounded-2xl max-w-4xl w-full p-6 shadow-2xl space-y-5 my-8 max-h-[90vh] overflow-y-auto">
            ...
            {/* Filter Bar */}
            <div className="flex flex-col sm:flex-row items-center gap-3 bg-secondary/60 p-3 rounded-xl border border-gray-700">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="bg-secondary border border-gray-700 text-white text-xs px-2.5 py-1.5 rounded-lg font-mono font-bold focus:outline-none focus:border-primary"
                />
              </div>
              ...
              <div className="flex items-center gap-2 flex-1 w-full sm:w-auto">
                ...
                <select
                  ...
                  className="bg-secondary border border-gray-700 text-white text-xs px-2.5 py-1.5 rounded-lg w-full font-medium focus:outline-none focus:border-primary"
                >
              ...
              return (
                <div className="space-y-4 text-xs">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                    <div className="bg-secondary/60 p-3 rounded-xl border border-gray-800">
                  ...
                  <div className="bg-secondary/60 border border-gray-800 rounded-xl overflow-hidden shadow-lg">
                    <div className="overflow-x-auto max-h-80 overflow-y-auto">
                      <table className="w-full text-left text-xs text-gray-300">
                        <thead className="bg-surface text-gray-400 uppercase text-[10px] tracking-wider font-semibold border-b border-gray-800 sticky top-0">
                          <tr>
