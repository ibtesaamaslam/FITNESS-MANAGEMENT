                      ...
                      <tr key={sale.id} className="hover:bg-secondary/30 transition-colors">
                        ...
                        <td className="py-3 px-4 text-right whitespace-nowrap">
                          {role === 'Admin' ? (
                            ...
                            <span className="text-gray-500 text-[10px] px-2 py-0.5 bg-gray-800/40 rounded border border-gray-700/50 cursor-not-allowed select-none" title="Admin authority required to refund or remove sales">
                              Admin Only
                            </span>
                          )}
                        </td>
